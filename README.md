...
You can download a copy of all the files in this repository by cloning the [git](https://git-scm.com/) repository:
    ...
    git clone https://github.com/AlvaroTorresMartos/GDM_UKBiobank


or [download a zip archive](https://github.com/AlvaroTorresMartos/GDM_UKBiobank/archive/refs/heads/master.zip).
...
The manuscript text is not open source. The authors reserve the rights to the article content, which is currently submitted for publication in the *BMC Medicine*.
